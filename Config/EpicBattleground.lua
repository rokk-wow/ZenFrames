...
function addon:GetDefaultConfig_EpicBattleground()
    return {
        friendly = {
            ...
            highlightSelected = true,            showEmptySlots = true,
            emptySlotColor = "00000080",            leftClick = "select",
            ...
            modules = {
                ...
                text = {
                    ...
                    {
                        name = "RaidEpicBattlegroundMaxHealthText",
                        enabled = true,
                        anchor = "CENTER",
                        relativePoint = "CENTER",
                        offsetX = 0,
        ...
        enemy = {
            ...
            modules = {
                ...
                text = {
                    ...
                    {
                        name = "RaidEpicBattlegroundEnemyMaxHealthText",
                        enabled = true,
                        anchor = "CENTER",
                        relativePoint = "CENTER",
                        offsetX = 0,
